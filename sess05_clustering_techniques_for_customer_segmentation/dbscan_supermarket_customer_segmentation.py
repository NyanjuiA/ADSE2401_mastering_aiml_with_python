...
def preprocess(df: pd.DataFrame):
   """
   Standardise the features. ( critical for DBSCAN distance calculations ).
   """
...
def plot_business_view(df):
   """Spend Vs. Frequency (Most intiutive business chart"""
   plt.figure(figsize=(8,6))
